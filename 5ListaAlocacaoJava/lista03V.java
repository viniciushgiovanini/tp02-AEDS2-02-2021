...
public class lista03V {
  ...
  public static void imprimirLista(String[] lista) {// IMPRIME O ARRAT LISTA
  ...
  public static String[] inserirInicio(String entrada, String[] lista) {// FAZ A INSERCAO NO INICIO DA LISTA, FAZENDO
                                                                        // SHIFT A DIREITA DE TODOS OS ELEMENTOS
  ...
  public static String[] inserirFim(String entrada, String[] lista) {// PEGA A ULTIMA POSICAO VAZIA DO ARRAY LISTA E
                                                                     // INSERE O ELEMENTO
  ...
  public static String[] inserirPosi(String entrada, String[] lista, int posi) {// INSERE O ELEMENTO EM QUALQUER
                                                                                // POSICAO, FAZENDO SHIFT A DIREITA PARA
                                                                                // ELEMENTOS JA PRESENTE NA POSICAO
                                                                                // REQUERIDA

    int qtdELEMENTOS = qtdelementos(lista);

    if (posi > qtdELEMENTOS) {
  ...
  public static String[] removerInicio(String[] lista) {// FAZ A REMOCAO DO ELEMENTO PRESENTE NA POSICAO 0 , FAZENDO
                                                        // SHIFT A ESQUERDA DE TODOS OS ELEMENTOS
  ...
  public static String[] removerFinal(String[] lista) {// REMOVE O ELEMENTO PRESENTE NA ULTIMA POSICAO DA LISTA
  ...
  public static String[] removerPosi(String entrada, String[] lista, int posi) {// REMOVE ELEMENTO DE QUALQUER POSICAO,
                                                                                // REQUERIDA, FAZENDO SHIFT A ESQUERDA
                                                                                // DOS ELEMENTOS RESTANTES

    int qtdELEMENTOS = 0;

    qtdELEMENTOS = qtdelementos(lista);
    ...
    if (posi > qtdELEMENTOS) {
      ...
      for (int j = posi; j < qtdELEMENTOS - 1; j++) {
  ...
  public static String[] montarlixo(String[] lista, String[] lixo, int operacao, int posi) {// ESSA FUNCAO TA EXPLICADA
  ...
  public static void main(String[] args) {
    ...
    Serielista222 nt = new Serielista222();
    while (!(entrada.equals("FIM"))) {
      ...
      lista[contadorarraylist] = nt.juntado;// PEGA A STRING CONCATENADA E COLOCA NA POSICAO DA LISTA
      contadorarraylist++;
    ...
    while (contadorentradanumerica2 < entradanumerica2) {
      ...
      // STRING VAI MUDAR O NUMERO DA VARIÁVEL OPERACAO, DESSA FORMA INFORMANDO NO IF
      // MAIS DE BAIXO QUAL OPERACAO VAI SER FEITA
      ...
      if (operacao == 4) {
        lixo = montarlixo(lista, lixo, operacao, 0);
        lista = removerInicio(lista);

      }

      if (operacao == 6) {
        int qtdelementosnalistaatual = qtdelementos(lista);
        lixo = montarlixo(lista, lixo, operacao, qtdelementosnalistaatual);
      ...
      if (operacao == 5) {
        lixo = montarlixo(lista, lixo, operacao, inteiroRP);
        lista = removerPosi(entrada, lista, inteiroRP);
      }
