...
public class lista02V {
  ...
  public static String[] removerPosi(String entrada, String[] lista, int posi) {
  ...
  public static void main(String[] args) {
    ...
    Serielista2 nt = new Serielista2();
    ...
    while (contadorentradanumerica2 < entradanumerica2) {
      ...
      if (operacao == 2) {
        ...
        if (letra33[4] == '0' || letra33[4] == '1' || letra33[4] == '2' || letra33[4] == '3' || letra33[4] == '4'
            || letra33[4] == '4' || letra33[4] == '6' || letra33[4] == '7' || letra33[4] == '8' || letra33[4] == '9') {
