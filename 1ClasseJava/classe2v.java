...
class Serie2 {
  ...
  public void buscanome() {
    ...
    for (int k = 0; k < buscar.length(); k++) {// CADA MÉTODO TEM SUA ESPECIFICAÇÃO NESSA PARTE, O MÉTODO BUSCAR
                                               // NOME
    ...
    for (int i = 0; i < vetorreceber.length; i++) {// ESSE FOR ESTÁ PRESENTE EM TODOS OS MÉTODOS, ELE É ENCARREGADO
                                                   // DE
                                                   ...
                                                   // COPIADO PARA ESSE VETOR FICOU SOBRANDO AS POSIÇÕES NÃO
                                                   // COPIADAS, E
  ...
  public void imprimir() {// ESSE MÉTODO PEGA TODOS OS GETS E DA UM ESÇACO ENTRE ELES E NO FINAL QUEBRA
                          // A
                          // LINHA
    ...
    System.out.print(getIdioma() + " ");
    System.out.print(getEmissora() + " ");
    System.out.print(getTrasmissao() + " ");
    System.out.print(getNtemporadasINTEIRO() + " ");
    System.out.print(getNepisodioINTEIRO());
    System.out.println();
...
public class classe2v {
  ...
  public static void main(String[] args) {
    ...
    Serie2 nt = new Serie2();// Faz a ligacao com a classe
    while (!(entrada.equals("FIM"))) {// roda até entrada ser digitado FIM
      ...
      try {
        ...
        while ((str = in.readLine()) != null) {
          ...
          // ONDE ESTÁ LOCALIZADO A MINHA LINHA DESEJADA, QUANDO ELE ENCONTRA A LINHA,
          // ELE
          // ACIONA A CLASSE E MANDA A STRING ENCONTRADA PRA CLASSE, E LOGO EM SEGUIDA ELE
          // ACIONA O MÉTODO BUSCAR DA LINHA ENCONTRADA, QUE VAI TER A FUNÇÃO DE LIMPAR
          // A
          ...
          if (str.contains(
              "<td scope=\"row\" style=\"vertical-align: top; text-align: left; font-weight:bold;\">País de origem</td>")) {// BUSCA
                                                                                                                            // O
                                                                                                                            // PAIS
                                                                                                                            // DE
                                                                                                                            // ORIGEM
          ...
          if (str.contains(
              "<td scope=\"row\" style=\"vertical-align: top; text-align: left; font-weight:bold;\">Emissora de televisão original</td>")) {// BUSCA
                                                                                                                                            // A
                                                                                                                                            // EMISSORA
            str = in.readLine();
            nt.setEmissora(str);
          ...
          if (str.contains(
              "<td scope=\"row\" style=\"vertical-align: top; text-align: left; font-weight:bold;\">Transmissão original</td>")) {// BUSCA
                                                                                                                                  // A
                                                                                                                                  // TRANSMISSAO
            str = in.readLine();
          ...
          if (str.contains(
              "<td scope=\"row\" style=\"vertical-align: top; text-align: left; font-weight:bold;\">N.º de temporadas</td>")) {// BUSCA
                                                                                                                               // O
                                                                                                                               // NUMERO
                                                                                                                               // DE
                                                                                                                               // TEMPORADAS
      ...
      nt.imprimir();// DEPOIS QUE ELE PEGAR TODAS AS LINHAS DO ARQUIVO ESCRITO ELE CHAMA O MÉTODO
                    // IMPRIMIR
